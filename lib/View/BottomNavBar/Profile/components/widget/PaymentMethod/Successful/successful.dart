...
import 'package:smiles/View/Invoice/invoice.dart';

import 'package:smiles/models/successfulPayments.dart';

import 'components/DentistProfile/dentistProfile.dart';
import 'components/Review/reviewForDoctor.dart';
import 'components/dropdDown.dart';
                ...
                Column(
                  children: [
                    GestureDetector(
                        ...
                        child: dropDown1('Review', Icons.rate_review)),
                    GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
